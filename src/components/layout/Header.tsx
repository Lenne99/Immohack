...
export function Header({ title }: { title?: string }) {
  ...
  return (
    <header className="h-16 bg-gray-950 border-b border-gray-800 flex items-center px-6 gap-4">
      {title && (
        <h2 className="text-white font-semibold text-lg hidden md:block min-w-max">{title}</h2>
      )}
